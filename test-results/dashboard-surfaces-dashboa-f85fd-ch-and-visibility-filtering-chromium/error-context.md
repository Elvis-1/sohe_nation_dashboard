...
- Name: dashboard-surfaces.spec.ts >> dashboard implemented surfaces >> products module supports search and visibility filtering
- Location: tests/e2e/dashboard-surfaces.spec.ts:91:7
...
Locator: getByRole('heading', { name: 'No product records match the current filters.' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'No product records match the current filters.' })
        ...
        - generic [ref=e77]:
          ...
          - generic [ref=e81]:
            - generic [ref=e82]:
              ...
              - textbox "Search catalog" [active] [ref=e84]:
                - /placeholder: Search by title, slug, or category
                - text: no-match-catalog-term
            - generic [ref=e85]:
