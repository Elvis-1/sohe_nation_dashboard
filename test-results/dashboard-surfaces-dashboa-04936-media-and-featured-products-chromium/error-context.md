...
- Name: dashboard-surfaces.spec.ts >> dashboard implemented surfaces >> homepage content editor limits editing to hero media and featured products
- Location: tests/e2e/dashboard-surfaces.spec.ts:332:7
